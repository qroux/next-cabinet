...
import Score from "@material-ui/icons/Minimize";
        ...
        <div>
          ...
          >
            <Typography variant="body1">
              ...
              car il existe des sujets plus à risque que d’autres de souffrir de
              déchaussement ou parodontite.
            </Typography>
            <br />
            ...
            <Typography variant="body1">
              ...
              <strong>
                ...
                permet de diminuer sensiblement la probabilité de déchaussement
              </strong>
            </Typography>
            <br />
            <Typography variant="body1">
